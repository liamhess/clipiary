...
|---|---|---|
| `panel` | `#1E1E1E` @ 0.85 | Outer shell / window background (when material is off). |
| `contentArea` | same as `panel` | Scrollable history/favorites area and search field. Defaults to the same value as `panel` when omitted from JSON. |
